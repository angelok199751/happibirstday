const articles = [
    ...
    },
    {
        id: 2,
        image: "photos/2.jpg",
        title: "За деньги — нет. Насчет всего остального — можно договориться",
    ...
    },
    {
        id: 5,
        image: "photos/11.jpg",
        title: "Моё тотемное животное — львица.",
    ...
    },
    {
        ...
        excerpt: "А на белом песке аквапарк. А в аквапарке прошла масштабная фотосессия с участием звезд Playboy. Особое внимание уделялось восходящей звезде - Сицилициной Анастасии. Она буквально приковывала все внимание зрителей и съемочной группы к себе. Сам Хью Хефнер дал комментарий, что новый \"кролик\" появится и на новогоднем календаре.",
        category: "Новости",
        icon: "💬",
        color: "#b45309"
    },
    ...
    },
    {
        ...
        excerpt: "“Еще никогда ягода не была ко мне так жестока” — именно этой фразой Анастасия Сицилицина встретила нашего корреспондента. К сожалению, более менее складного диалога дальше не получилось, так как у дивы обнаружились серьезные провалы в памяти, отрицание вертикального положения, неприятный привкус во рту и в целом отсутствие желания жить дальше. Поэтому наш корреспондент спешно проводит спасательную операцию и в срочном порядке выехал в ближайший магазин “за минералочкой”.",
        category: "Интервью",
        icon: "🎤",
        color: "#d9c706ff"
    },
        ...
        excerpt: "Наш корреспондент оказал первую помощь местной диве Анастасии Сицилициной, привезя минералочку и таблетки аспирина. А также предоставил материалы прошедшего вечера, что и позволило запечатлеть непередаваемые эмоции счастья и восторга на лице Анастасии Юрьевны. Однако, съемочной группе пришлось срочно сворачиваться и покидать место съемок под предлогом, что гостям не гоже долго задерживаться. И поездка корреспондента в травмпункт никак с этим не связана.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    adPopup.className = 'meme-popup';
    adPopup.innerHTML = `<img class="meme-popup-img" src="" alt="Реклама">`;
    document.body.appendChild(adPopup);
    const adPopupImg = adPopup.querySelector('.meme-popup-img');
