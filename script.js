const articles = [
    ...
    },
    {
        ...
        excerpt: "Наш корреспондент оказал первую помощь местной диве Анастасии Сицилициной, и привез минералочку и таблетки аспирина. А также предоставил материалы прошедшего вечера, что и позволило запечатлеть непередаваемые эмоции счастья и восторга на лице Анастасии Юрьевной. Однако съемочной группе пришлось срочно сворачиваться и покидать место съемок, под предлогом, что гостям не гоже долго задерживаться. И поездка корреспондента в травмпункт никак с этим не связана.",
